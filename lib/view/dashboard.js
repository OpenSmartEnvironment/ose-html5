...
exports.addStateObj = function(stateObj) {  // {{{2
/**
 * Adds an item defined by `stateObj` to the dashboard.
 *
 ...
 */
  ...
  return this.addItem(stateObj.caption, O.ui.bindContent(stateObj));
};
