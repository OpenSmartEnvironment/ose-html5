 ...
 */
  ...
  if (this.control && this.control.patch) {
    wrap.on('patch', this.control.patch.bind(null, this, wrap));
    return this;
  }

  wrap.on('patch', Function('el', 'wrap', 'patch', 'el.textContent = wrap.field.asEditText(wrap.value);').bind(undefined, this.el, wrap));
  return this;
};
...
exports.img = function(src, attrs, params) {  // {{{2
/**
 ...
 */
  ...
  var res = this.tree('img', attrs, params).
    attr('src', src)
  ;
