 ...
 *
 * @readme
 * OSE package providing an mobile-first HTML5 user interface built
 * using [html5
 * components](https://developer.mozilla.org/en-US/Apps/Design/Firefox_OS_building_blocks).
 *
 * As the current implementation of html5 components is based on Web
 ...
 *
 * @features
 * - HTML5 user interface optimized for phones and tablets based on
 *  [html5 components]
