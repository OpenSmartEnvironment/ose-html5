...
//  console.log('UI RUN');
  ...
  this.body.register('button', './control/button');
  this.body.register('buttons', './control/buttons');
  this.body.register('checkbox', './control/checkbox');
  this.body.register('onoff', './control/onoff');
  this.body.register('slider', './control/slider');
